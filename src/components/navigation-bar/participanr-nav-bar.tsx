...
import { participantTabs } from '@/constants/configuration-constannts';
...
function ParticipantNavBar() {
  ...
  const handleClickNavItem = (index: number) => {
    if (index === 0) router.push('/participant-home');
    else if (index === 1) router.push('/participant-home/bookings');
    else router.push('/participant-home/help');
  };
